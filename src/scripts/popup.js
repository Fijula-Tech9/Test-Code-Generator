  ...
  try {
    ...
    const modelsByProvider = {
      groq: [
        ...
        { value: 'qwen-qwq-32b', label: 'Qwen 32B' }
      ],
      openai: [
        ...
        { value: 'ft:gpt-4o-mini-2024-07-18:internals::BiQFUOwm', label: 'Salesforce (SFT)' },
        { value: 'ft:gpt-4o-2024-08-06:internals::BB0krlOz', label: 'Salesforce (DPO)' }
